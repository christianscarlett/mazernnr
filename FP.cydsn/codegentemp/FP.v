// ======================================================================
// FP.v generated from TopDesign.cysch
// 05/13/2021 at 00:57
...
module top ;
    ...
    assign Net_656 = (Net_756[11:0] < Net_653[11:0]);
    ...
    assign Net_657 = (Net_756[11:0] >= Net_649[11:0]);

    assign Net_582 = 1'h1;

    assign Net_637 = (Net_633[11:0] < Net_638[11:0]);

    assign Net_639 = (Net_633[11:0] >= Net_635[11:0]);
    ...
    BasicCounter_v1_0 VerticalCounter (
        ...
        .reset(Net_674),
        .clock(Net_1085));
    defparam VerticalCounter.Width = 12;
    ...
    BasicCounter_v1_0 HorizontalCounter (
        ...
        .reset(Net_1085),
        .clock(Net_1810));
    defparam HorizontalCounter.Width = 12;
    ...
    assign Net_635[11:0] = 12'hD2;

    assign Net_638[11:0] = 12'hF2;

	wire [0:0] tmpOE__h_sync_net;
	wire [0:0] tmpFB_0__h_sync_net;
    ...
    assign Net_978 = (Net_633[11:0] < Net_765[11:0]);

    assign Net_649[11:0] = 12'h259;

    assign Net_653[11:0] = 12'h25D;


    assign Net_659 = Net_656 & Net_657;

	wire [0:0] tmpOE__v_sync_net;
	wire [0:0] tmpFB_0__v_sync_net;
    ...
    assign Net_1085 = (Net_633[11:0] == Net_665[11:0]);

    assign Net_665[11:0] = 12'h107;

    assign Net_674 = (Net_756[11:0] == Net_673[11:0]);

    assign Net_673[11:0] = 12'h273;

	wire [0:0] tmpOE__CLK_PIN_net;
	wire [0:0] tmpIO_0__CLK_PIN_net;
	wire [0:0] tmpINTERRUPT_0__CLK_PIN_net;
	electrical [0:0] tmpSIOVREF__CLK_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9929dff4-a273-4cc1-b385-b623cc018987"),
		  ...
		  .input_buffer_sel(2'b00))
		CLK_PIN
		 (.oe(tmpOE__CLK_PIN_net),
		  .y({1'b0}),
		  .fb({Net_1810}),
		  .io({tmpIO_0__CLK_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__CLK_PIN_net),
		  .interrupt({tmpINTERRUPT_0__CLK_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CLK_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_644 = Net_637 & Net_639;

    assign Net_765[11:0] = 12'hC8;


    assign Net_788 = Net_1181 & Net_1184;

    assign Net_1079 = (Net_756[11:0] < Net_776[11:0]);

    assign Net_776[11:0] = 12'h258;

    assign Net_869 = (Net_633[11:0] == Net_1164[11:0]);


    assign Net_1181 = Net_1079 & Net_978;


    assign Net_789 = ~Net_788;
    ...
    FreqDiv_v1_0 FreqDiv_2 (
        ...
        .reset(Net_1077),
        .clock(Net_869));
    defparam FreqDiv_2.Divider = 30;
    defparam FreqDiv_2.highPulse = 15;
    defparam FreqDiv_2.numBits = 5;

    assign Net_1164[11:0] = 12'hC8;


    assign Net_1077 = ~Net_1079;

    assign Net_1019 = 1'h1;
    ...
    assign Net_987 = Net_1097 & Net_978 & Net_1117;
    ...
    assign Net_1114 = ~(Net_1113 | Net_1117);


    assign Net_1178 = Net_1181 & Net_1176;
    ...
    assign Net_1065 = 1'h1;


    assign Net_1117 = ~(Net_1114 | Net_1115);


    assign Net_1113 = Net_1158 & Net_1127 & Net_1132;

    assign Net_1115 = 1'h0;

    assign Net_1127 = (Net_756[11:0] == Net_1343[11:0]);

    assign Net_1158 = (Net_633[11:0] == Net_1339[11:0]);

    assign Net_1339[11:0] = 12'h0;

    assign Net_1343[11:0] = 12'h0;
    ...
    assign Net_1182 = Net_1181 & Net_1180;


    assign Net_1179 = ~Net_1182;
    ...
    Timer_v2_70_4 GameTimer (
        .reset(Net_12),
        .interrupt(Net_1390),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1394),
        .tc(Net_1395),
        .clock(Net_10));
    defparam GameTimer.CaptureCount = 2;
    defparam GameTimer.CaptureCounterEnabled = 0;
    defparam GameTimer.DeviceFamily = "PSoC5";
    defparam GameTimer.InterruptOnCapture = 0;
    defparam GameTimer.InterruptOnTC = 0;
    defparam GameTimer.Resolution = 32;
    defparam GameTimer.SiliconRevision = "0";
