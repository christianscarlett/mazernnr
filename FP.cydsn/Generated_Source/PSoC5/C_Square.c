...
void C_Square_Start(void) 
{
    ...
    C_Square_CLKEN |= C_Square_CLKEN_MASK;
	C_Square_CLKSTBY |= C_Square_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: C_Square_Stop
********************************************************************************
*
* Summary:
...
void C_Square_Stop(void) 
{
    ...
    C_Square_CLKEN &= (uint8)(~C_Square_CLKEN_MASK);
	C_Square_CLKSTBY &= (uint8)(~C_Square_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: C_Square_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((C_Square_CLKEN & C_Square_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = C_Square_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = C_Square_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* C_Square__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(C_Square_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(C_Square_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: C_Square_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: C_Square_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = C_Square_GetSourceRegister();
    uint16 oldDivider = C_Square_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = C_Square_CLKEN & C_Square_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((C_Square_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: C_Square_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(C_Square_DIV_PTR);
}


/*******************************************************************************
* Function Name: C_Square_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    C_Square_MOD_SRC |= modeBitMask & (uint8)C_Square_MODE_MASK;
}


/*******************************************************************************
* Function Name: C_Square_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    C_Square_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(C_Square_MODE_MASK));
}


/*******************************************************************************
* Function Name: C_Square_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return C_Square_MOD_SRC & (uint8)(C_Square_MODE_MASK);
}


/*******************************************************************************
* Function Name: C_Square_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = C_Square_GetDividerRegister();
    uint8 oldSrc = C_Square_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        C_Square_MOD_SRC |= CYCLK_SSS;
        C_Square_MOD_SRC =
            (C_Square_MOD_SRC & (uint8)(~C_Square_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: C_Square_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return C_Square_MOD_SRC & C_Square_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: C_Square_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    C_Square_PHASE = clkPhase & C_Square_PHASE_MASK;
}


/*******************************************************************************
* Function Name: C_Square_GetPhase
********************************************************************************
*
* Summary:
...
{
    return C_Square_PHASE & C_Square_PHASE_MASK;
}
